...
namespace Yumms.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderID,Date,Total_Amount,Status,Product_Count,UserID,ProductID")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderID,Date,Total_Amount,Status,Product_Count,UserID,ProductID")] Order order)
        {
            if (ModelState.IsValid)
            {
